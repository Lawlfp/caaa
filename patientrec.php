  ...
  <?php endif; ?>
															...
															<div class="patientcontainer2">
																					<div class="flexcontainer1">
																						...
																						<button style="font-family:Roboto;font-size:11px;font-weight:bold;color:#BEBBBB;margin-top:10px; margin-left:110px;background:none;outline:none;border:none;">Edit</button>
																					...
																					?>
																					<div class="flexcontainernoline" style="display:flex;align-items:center;justify-content:center;margin-bottom:20px;"><button style="outline:none;border:none;background: none; text-decoration: underline;color:#248AA2;hover:pointer;">View All</button></div>	
																				</div>
																				...
																				<!-- PRESCRIPTION HISTORY-->	
																										...
																										<div class="patientcontainer3">
																											<div class="flexcontainer1">
																												...
																												<button style="font-family:Roboto;font-size:11px;font-weight:bold;color:#BEBBBB;margin-top:15px; margin-left:90px;background:none;outline:none;border:none;">Edit</button>		
																											...
																											<div class="flexcontainernoline" style="display:flex;align-items:center;justify-content:center;margin-bottom:20px;">
																												<button style="outline:none;border:none;background: none; text-decoration: underline;color:#248AA2;hover:pointer;">View All</button>
																											</div>	
																										</div>
																				...
																				<!-- TREATMENT HISTORY-->
																										...
																										<div class="patientcontainer4">
																											<div class="flexcontainer1">
																												...
																												<img src="presc.png" class="smallicons" style="margin-top:34px;margin-left:8px;">
																												<button style="font-family:Roboto;font-size:11px;font-weight:bold;color:#BEBBBB;margin-top:10px; margin-left:90px;background:none;outline:none;border:none;">Edit</button>
																												<button style="font-family:Roboto;font-size:11px;font-weight:bold;color:red;margin-top:10px; margin-left:5px;background:none;outline:none;border:none;" hidden>Cancel</button>										
																											</div>
																											...
																											<div class="flexcontainernoline" style="display:flex;align-items:center;justify-content:center;margin-bottom:20px;">
																												<button style="outline:none;border:none;background: none; text-decoration: underline;color:#248AA2;">View All</button>
																											</div>
																										</div>
